 ...
 * 
 */
class  WpOpal_Customizer_Control_Style_Background extends WpOpal_Customizer_Control_Style {
	public $suffix = 'background';
	public $template = '$selector { background: $value; }';
	...
	public function post_message( $js='' ) {
		...
		$js .= str_replace(
			...
			file_get_contents( WPOPAL_PLUGIN_DIR . '/assets/js/customize/post-message-part-background.js' )
		);
	...
	public function get_css(){
		...
		return apply_filters( 'styles_css_background', $css );
	}
}