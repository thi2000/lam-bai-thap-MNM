...
class OSF_Elementor_Fixed_Header_Module  {
	...
	public function register_controls( Controls_Stack $element ) {
		...
		$element->start_controls_section(
			...
			[
				'label' => __( 'Header Rich Features', 'opalelementor' ),
		...
		$element->add_control(
			'abs_header',
			[
				'label' => __( 'Enable Absolute Header', 'opalelementor' ),
				...
				'prefix_class'  => 'opalelementor-abs-header-'
			]
		);
		...
		*/
		...
		$element->add_control(
			'fixed_header',
			[
				'label' => __( 'Enable Fixed Left Header', 'opalelementor' ),
				'type' => Controls_Manager::SWITCHER,
				'label_on' => __( 'On', 'opalelementor' ),
				'label_off' => __( 'Off', 'opalelementor' ),
				'return_value' => 'yes',
		...
		$element->add_control(
			'enable_veritcal_writing',
			[
				'label' => __( 'Enable Vertical Writing Mode', 'opalelementor' ),
				'type' => Controls_Manager::SWITCHER,
				'label_on' => __( 'On', 'opalelementor' ),
				'label_off' => __( 'Off', 'opalelementor' ),
				'return_value' => 'yes',
	...
	public function before_render_section( $section ){
		...
		if(  isset($settings['fixed_header']) && $settings['fixed_header'] == 'yes' ) {
			...
			if( isset($settings['fixed_header_width']) ) {
				$section->add_render_attribute( '_wrapper', 'data-width', 
				$settings['fixed_header_width']['size'].$settings['fixed_header_width']['unit'] );
			}
		}
 		
 		if(  isset($settings['enable_veritcal_writing']) && $settings['enable_veritcal_writing'] == 'yes' ) {
			$section->add_render_attribute( '_wrapper', 'class', 'opalelementor-writing-veritcal' );
