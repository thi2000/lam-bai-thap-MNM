...
class OSF_Widget_Toggle extends Widget_Toggle {
	...
	protected function _register_controls() {
		...
		$this->add_control(
			'tabs',
			[
				'label' => __( 'Toggle Items', 'opalelementor' ),
				'type' => Controls_Manager::REPEATER,
				'default' => [
					[
						'tab_title' => __( 'Toggle #1', 'opalelementor' ),
						'tab_content' => __( 'I am item content. Click edit button to change this text. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit tellus, luctus nec ullamcorper mattis, pulvinar dapibus leo.', 'opalelementor' ),
					],
					[
						'tab_title' => __( 'Toggle #2', 'opalelementor' ),
						'tab_content' => __( 'I am item content. Click edit button to change this text. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit tellus, luctus nec ullamcorper mattis, pulvinar dapibus leo.', 'opalelementor' ),
					],
				],
				'fields' => [
					[
						...
						'default' => __( 'Toggle Title' , 'opalelementor' ),
						'label_block' => true,
					],
					[
						'name' => 'tab_content',
						...
						'default' => __( 'Toggle Content', 'opalelementor' ),
						'show_label' => false,
					],
				],
		...
		$this->add_control(
			'icon_active',
			[
				'label' => __( 'Active Icon', 'opalelementor' ),
				'type' => Controls_Manager::ICON,
		...
		$this->add_control(
			'show_item_first',
			[
				'label' => __( 'Show Item First', 'opalelementor' ),
        ...
        $this->add_control(
            'event_type',
            [
                'label' => __( 'Event Type', 'opalelementor' ),
                'type' => Controls_Manager::SELECT,
                'options' => array(
                    'toggle' => 'Toggle',
                    'accordion' => 'Accordion'
		...
		$this->add_control(
			...
			[
				...
				'options' => [
					'left' => [
						'title' => __( 'Start', 'opalelementor' ),
						'icon' => 'eicon-h-align-left',
					],
					'right' => [
						'title' => __( 'End', 'opalelementor' ),
