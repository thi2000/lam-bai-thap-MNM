...
class OSF_Elementor_Iconbox_gradient_widget extends Widget_Base {
	...
	public function get_title() {
		return __( 'Icon Box Gradient', 'opalopalelementor' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'section_icon',
			[
				'label' => __( 'Icon Box', 'opalopalelementor' ),
			]
		);
		...
		$this->add_control(
			'icon',
			[
				'label' => __( 'Icon', 'opalopalelementor' ),
		...
		$this->add_control(
			'view',
			[
				'label' => __( 'View', 'opalopalelementor' ),
				'type' => Controls_Manager::SELECT,
				'options' => [
					'default' => __( 'Default', 'opalopalelementor' ),
					'stacked' => __( 'Stacked', 'opalopalelementor' ),
					'framed' => __( 'Framed', 'opalopalelementor' ),
				],
				'default' => 'default',
		...
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::SELECT,
				'options' => [
					'circle' => __( 'Circle', 'opalopalelementor' ),
					'square' => __( 'Square', 'opalopalelementor' ),
				],
				'default' => 'circle',
				'condition' => [
					'view!' => 'default',
		...
		$this->add_control(
			'title_text',
			[
				'label' => __( 'Title & Description', 'opalopalelementor' ),
				'type' => Controls_Manager::TEXT,
				'dynamic' => [
					'active' => true,
				],
				'default' => __( 'This is the heading', 'opalopalelementor' ),
				'placeholder' => __( 'Enter your title', 'opalopalelementor' ),
				'label_block' => true,
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => __( 'Click edit button to change this text. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit tellus, luctus nec ullamcorper mattis, pulvinar dapibus leo.', 'opalopalelementor' ),
				'placeholder' => __( 'Enter your description', 'opalopalelementor' ),
				'rows' => 10,
				'separator' => 'none',
				'show_label' => false,
			]
		...
		$this->add_control(
			'link',
			[
				'label' => __( 'Link', 'opalopalelementor' ),
				'type' => Controls_Manager::URL,
				'dynamic' => [
					'active' => true,
				],
				'placeholder' => __( 'https://your-link.com', 'opalopalelementor' ),
				'separator' => 'before',
			]
		);
		...
		$this->add_control(
			'position',
			[
				'label' => __( 'Icon Position', 'opalopalelementor' ),
				'type' => Controls_Manager::CHOOSE,
				'default' => 'top',
				'options' => [
					'left' => [
						'title' => __( 'Left', 'opalopalelementor' ),
						'icon' => 'fa fa-align-left',
					],
					'top' => [
						'title' => __( 'Top', 'opalopalelementor' ),
						'icon' => 'fa fa-align-center',
					],
					'right' => [
						'title' => __( 'Right', 'opalopalelementor' ),
		...
		$this->add_control(
			'title_size',
			[
				'label' => __( 'Title HTML Tag', 'opalopalelementor' ),
				'type' => Controls_Manager::SELECT,
				'options' => [
					'h1' => 'H1',
					'h2' => 'H2',
		...
		$this->start_controls_tab(
			'icon_colors_normal',
			[
				'label' => __( 'Normal', 'opalopalelementor' ),
			]
		);
		...
		$this->add_control(
			'primary_color',
			[
				'label' => __( 'Primary Color', 'opalopalelementor' ),
		...
		$this->start_controls_tab(
			'icon_colors_hover',
			[
				'label' => __( 'Hover', 'opalopalelementor' ),
			]
		);
		...
		$this->add_control(
			...
			[
				'label' => __( 'Secondary Color', 'opalopalelementor' ),
				'type' => Controls_Manager::COLOR,
				'default' => '',
				'condition' => [
					'view!' => 'default',
		...
		$this->add_control(
			'hover_animation',
			[
				'label' => __( 'Hover Animation', 'opalopalelementor' ),
		...
		$this->add_responsive_control(
			'icon_space',
			[
				'label' => __( 'Spacing', 'opalopalelementor' ),
		...
		$this->add_control(
			'icon_padding',
			[
				'label' => __( 'Padding', 'opalopalelementor' ),
				'type' => Controls_Manager::SLIDER,
				'selectors' => [
		...
		$this->add_control(
			'rotate',
			[
				'label' => __( 'Rotate', 'opalopalelementor' ),
				'type' => Controls_Manager::SLIDER,
				'default' => [
					'size' => 0,
					'unit' => 'deg',
