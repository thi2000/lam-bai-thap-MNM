...
class OSF_Elementor_Flip_box_Widget extends Elementor\Widget_Base {
	...
	public function get_title() {
		return __( 'Opal Flip Box', 'opalelementor' );
	}
	...
	protected function _register_controls() {
		...
		$this->start_controls_section(
			...
			[
				'label' => __( 'Front', 'opalelementor' ),
			]
		);

		$this->start_controls_tabs( 'side_a_content_tabs' );

		$this->start_controls_tab( 'side_a_content_tab', [ 'label' => __( 'Content', 'opalelementor' ) ] );
		...
		$this->start_controls_tab( 'side_a_background_tab', [ 'label' => __( 'Background', 'opalelementor' ) ] );
		...
		$this->add_control(
			...
			[
				'label' => __( 'Background Overlay', 'opalelementor' ),
		...
		$this->start_controls_section(
			...
			[
				'label' => __( 'Back', 'opalelementor' ),
			]
		);

		$this->start_controls_tabs( 'side_b_content_tabs' );

		$this->start_controls_tab( 'side_b_content_tab', [ 'label' => __( 'Content', 'opalelementor' ) ] );
		...
		$this->start_controls_tab( 'side_b_background_tab', [ 'label' => __( 'Background', 'opalelementor' ) ] );
		...
		$this->add_control(
			'flip_effect',
			[
				'label' => __( 'Flip Effect', 'opalelementor' ),
				'type' => Controls_Manager::SELECT,
				'default' => 'flip',
				'options' => [
					'flip' => 'Flip',
		...
		$this->add_control(
			'flip_direction',
			[
				'label' => __( 'Flip Direction', 'opalelementor' ),
				'type' => Controls_Manager::SELECT,
				'default' => 'up',
				'options' => [
					'left' => __( 'Left', 'opalelementor' ),
					'right' => __( 'Right', 'opalelementor' ),
					'up' => __( 'Up', 'opalelementor' ),
					'down' => __( 'Down', 'opalelementor' ),
				],
				'condition' => [
					'flip_effect!' => [
							'fade',
		...
		$this->add_control(
			'flip_3d',
			[
				'label' => __( '3D Depth', 'opalelementor' ),
		...
		$this->add_control(
			'icon_rotate',
			[
				'label' => __( 'Icon Rotate', 'opalelementor' ),
				'type' => Controls_Manager::SLIDER,
				'default' => [
					'size' => 0,
					'unit' => 'deg',
