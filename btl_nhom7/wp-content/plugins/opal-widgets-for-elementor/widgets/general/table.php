...
class OSF_Elementor_Table_Widget extends Widget_Base {
	...
	protected function get_repeater_controls($repeater, $condition = [] ){
		...
		$repeater->add_control('table_text',
			[
				'label'         => esc_html__('Text', 'striz-core'),
		...
		$repeater->add_control('table_icon_selector',
			[
				'label'        => esc_html__('Icon Type','striz-core'),
				'type'         => Controls_Manager::SELECT,
				'default'      => 'font-awesome-icon',
				'options'      =>[
					'font-awesome-icon' => esc_html__('Font Awesome Icon','striz-core'),
					'custom-image'     => esc_html__('Custom Image','striz-core'),
				],
				'condition'     => array_merge( $condition, [] ),
			]
		);
		...
		$repeater->add_control('table_cell_icon',
			[
				'label'         => esc_html__('Icon', 'striz-core'),
		...
		$repeater->add_control('table_cell_icon_img',
			[
				'label'        => esc_html__('Custom Image','striz-core'),
		...
		$repeater->add_control('table_cell_icon_align',
			[
				'label'         => esc_html__('Icon Position', 'striz-core'),
				'type'          => Controls_Manager::SELECT,
				'default'       => 'before',
				'options'       => [
					'top'           => esc_html__('Top', 'striz-core'),
					'before'        => esc_html__('Before', 'striz-core'),
					'after'         => esc_html__('After', 'striz-core'),
				],
				'condition'	=> array_merge( $condition, [] ),
				'label_block'   => true,
			]
		...
		$repeater->add_control('table_cell_icon_spacing',
			[
				'label'         => esc_html__('Icon Spacing', 'striz-core'),
		...
		$repeater->add_control('table_cell_row_span',
			[
				'label'         => esc_html__('Row Span', 'striz-core'),
				'type'          => Controls_Manager::NUMBER,
				'title'         => esc_html__('Enter the number of rows for the cell', 'striz-core'),
				'default'       => 1,
				'min'           => 1,
				'max'           => 10,
				'condition'     => array_merge( $condition, [] ),
		...
		$repeater->add_control('table_cell_span',
			[
				'label'         => esc_html__('Column Span', 'striz-core'),
				'type'          => Controls_Manager::NUMBER,
				'title'         => esc_html__('Enter the number of columns for the cell', 'striz-core'),
				'default'       => 1,
				'min'           => 1,
				'max'           => 10,
				'condition'     => array_merge( $condition, [] ),
		...
		$repeater->add_responsive_control('table_cell_align',
			[
				'label'         => esc_html__( 'Alignment', 'striz-core' ),
				'type'          => Controls_Manager::CHOOSE,
				'options'       => [
					'left'      => [
						'title'=> esc_html__( 'Left', 'striz-core' ),
						'icon' => 'fa fa-align-left',
					],
					'center'    => [
						'title'=> esc_html__( 'Center', 'striz-core' ),
						'icon' => 'fa fa-align-center',
					],
					'right'     => [
						'title'=> esc_html__( 'Right', 'striz-core' ),
	...
	protected function _register_controls(){
		...
		$this->start_controls_section('table_data_section',
			[
				'label'     => esc_html__('Data', 'striz-core'),
			]
		);

		$this->add_control('table_data_type',
			[
				'label'     => esc_html__('Data Type', 'striz-core'),
				'type'      => Controls_Manager::SELECT,
				'options'   => [
					'custom'    => esc_html__('Custom', 'striz-core'),
					'csv'       => 'CSV' . esc_html__(' File','striz-core')
				],
				'default'   => 'custom'
			]);
		...
		$this->add_control('table_csv_type',
			[
				'label'     => esc_html__('File Type', 'striz-core'),
				'type'      => Controls_Manager::SELECT,
				'options'   => [
					'file'      => esc_html__('Upload FIle', 'striz-core'),
					'url'       => esc_html__('Remote File','striz-core')
				],
				'condition' => [
					'table_data_type'   => 'csv',
				],
		...
		$this->add_control('table_csv',
			[
				'label'     => esc_html__('Upload CSV File', 'striz-core'),
				'type'      => Controls_Manager::MEDIA,
				'condition' => [
					'table_data_type'   => 'csv',
					'table_csv_type'    => 'file'
		...
		$this->add_control('table_csv_url',
			[
				'label'     => esc_html__('File URL', 'striz-core'),
				'type'      => Controls_Manager::TEXT,
				'label_block'   => true,
				'condition' => [
					'table_data_type'   => 'csv',
		...
		$this->start_controls_section('table_head_section',
			[
				'label'     => esc_html__('Head', 'striz-core'),
				'condition' => [
		...
		$this->add_control('table_head_repeater',
			[
				'label'         => esc_html__('Cell', 'striz-core'),
				'type'          => Controls_Manager::REPEATER,
				'fields'        => $head_repeater->get_controls(),
				'default'       => [
					[
						'table_text'    => esc_html__('First Head', 'striz-core'),
					],
					[
						'table_text'    => esc_html__('Second Head', 'striz-core'),
					],
					[
						'table_text'    => esc_html__('Third Head', 'striz-core'),
					]
				],
		...
		$this->start_controls_section('table_body_section',
			[
				'label'     => esc_html__('Body', 'striz-core'),
				'condition' => [
					'table_data_type'   => 'custom'
				]
			]
		...
		$body_repeater->add_control('table_elem_type',
			[
				'label'     => esc_html__('Type', 'striz-core'),
				'type'      => Controls_Manager::SELECT,
				'options'   => [
					'cell'      => esc_html__('Cell', 'striz-core'),
					'row'       => esc_html__('Row', 'striz-core'),
				],
				'default'   => 'cell'
			]
		);
		...
		$body_repeater->add_control('table_cell_type',
			[
				'label'     => esc_html__('Cell Type', 'striz-core'),
				'type'      => Controls_Manager::SELECT,
				'options'   => [
					'td'        => esc_html__('Body', 'striz-core'),
					'th'        => esc_html__('Head', 'striz-core'),
				],
				'default'   => 'td',
				'condition'     => [
		...
		$body_repeater->add_control('table_link_selection',
			[
				'label'         => esc_html__('Link Type', 'striz-core'),
				'type'          => Controls_Manager::SELECT,
				'options'       => [
		...
		$this->add_control('table_body_repeater',
			[
				...
				'default' 	=> [
					...
					[
						'table_elem_type' 			=> 'cell',
						'table_text'                => esc_html__( 'Column #1', 'striz-core' ),
					],
					[
						'table_elem_type' 			=> 'cell',
						'table_text'                => esc_html__( 'Column #2', 'striz-core' ),
					],
					[
						'table_elem_type'           => 'cell',
						'table_text'                => esc_html__( 'Column #3', 'striz-core' ),
					],
					[
						'table_elem_type'           => 'row',
					],
		...
		$this->start_controls_section('table_display',
			[
				'label'         => esc_html__('Display Options', 'striz-core'),
			]
		);

		$this->add_responsive_control('table_width',
			[
				'label'         => esc_html__('Width', 'striz-core'),
				'type'          => Controls_Manager::SLIDER,
				'size_units'    => ['px', '%'],
				'range'         => [
					'px'    => [
		...
		$this->add_control('table_responsive',
			[
				'label' 		=> esc_html__( 'Responsive', 'striz-core' ),
				'type' 			=> Controls_Manager::SWITCHER,
				'description'   => esc_html__( 'Enables scroll on mobile.', 'striz-core' ),
		...
		$this->add_responsive_control('table_align',
			[
				'label'         => esc_html__( 'Table Alignment', 'striz-core' ),
				'type'          => Controls_Manager::CHOOSE,
				'options'       => [
					'flex-start'      => [
						'title'=> esc_html__( 'Left', 'striz-core' ),
		...
		$this->start_controls_tab('table_odd_head_odd_style',
			[
				'label'     => esc_html__('Odd', 'striz-core'),
			]
		);
		...
		$this->add_control('table_odd_head_hover_color',
			[
				'label'         => esc_html__('Text Hover Color', 'striz-core'),
				'type'          => Controls_Manager::COLOR,
				'scheme'        => [
					'type'      => Scheme_Color::get_type(),
					'value'     => Scheme_Color::COLOR_1,
		...
		$this->add_control('table_odd_head_icon_color',
			[
				'label'         => esc_html__('Icon Color', 'striz-core'),
				'type'          => Controls_Manager::COLOR,
				'scheme'        => [
					'type'      => Scheme_Color::get_type(),
					'value'     => Scheme_Color::COLOR_1,
		...
		$this->add_control('table_odd_head_background_popover',
			[
				'label'         => esc_html__('Background', 'striz-core'),
		...
		$this->add_control('table_odd_head_background_heading',
			[
				'label'             => esc_html__('Normal', 'striz-core'),
		...
		$this->add_control('table_odd_head_hover_background_heading',
			[
				'label'             => esc_html__('Hover', 'striz-core'),
				'type'              => Controls_Manager::HEADING
			]);
		...
		$this->start_controls_tab('table_head_even_style',
			[
				'label'     => esc_html__('Even', 'striz-core'),
			]
		);
		...
		$this->start_controls_section('table_row_style',
			[
				'label'         => esc_html__('Rows', 'striz-core'),
				'tab'           => Controls_Manager::TAB_STYLE
			]
		);
		...
		$this->start_controls_section('table_col_style',
			[
				'label'         => esc_html__('Columns', 'striz-core'),
				'tab'           => Controls_Manager::TAB_STYLE
			]
		);
		...
		$this->start_controls_section('table_style',
			[
				'label'         => esc_html__('Table', 'striz-core'),
				'tab'           => Controls_Manager::TAB_STYLE
			]
		);
