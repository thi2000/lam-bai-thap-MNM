...
class OSF_Elementor_Social_share_Widget extends Elementor\Widget_Base {
    ...
    public function get_title() {
        return __( 'Opal Social Share', 'opalelementor' );
    }
    ...
    protected function _register_controls() {
        $this->start_controls_section(
            ...
            [
                'label' => __( 'Share Buttons', 'opalelementor' ),
            ]
        );
        ...
        $this->add_control(
            'socials',
            [
                'label' => __( 'Select Socials', 'opalelementor' ),
        ...
        $this->add_control(
            ...
            [
                ...
                'options' => [
                    'gradient' => __( 'Gradient', 'opalelementor' ),
                    'minimal' => __( 'Minimal', 'opalelementor' ),
                    'framed' => __( 'Framed', 'opalelementor' ),
                    'boxed' => __( 'Boxed Icon', 'opalelementor' ),
                    'flat' => __( 'Flat', 'opalelementor' ),
                ],
                'default' => 'gradient',
        ...
        $this->add_control(
            ...
            [
                ...
                'options' => [
                    ...
                    'rounded' => __( 'Rounded', 'opalelementor' ),
        ...
        $this->add_control(
            ...
            [
                ...
                'options' => [
                    ...
                    'justify' => [
                        'title' => __( 'Justify', 'opalelementor' ),
        ...
        $this->add_responsive_control(
            'row_gap',
            [
                'label'     => __( 'Rows Gap', 'opalelementor' ),
                'type' => Controls_Manager::SLIDER,
                'default' => [
                    'size' => 10,
                ],
        ...
        $this->add_responsive_control(
            'button_size',
            [
                'label' => __( 'Button Size', 'opalelementor' ),
                'type' => Controls_Manager::SLIDER,
                'range' => [
                    'px' => [
                        'min' => 0.5,
        ...
        $this->add_responsive_control(
            'button_height',
            [
                'label' => __( 'Button Height', 'opalelementor' ),
                'type' => Controls_Manager::SLIDER,
                'range' => [
                    'em' => [
                        'min' => 1,
            ...
            <?php foreach ( $settings['socials'] as $button ) {
                ...
                <div class="elementor-grid-item">
                    <div class="elementor-share-btn">
                        <a href="<?php $this->render_html_social($button); ?>" target="_blank" title="<?php printf( __('Share on %s', 'opalelementor'), $title)?>">
