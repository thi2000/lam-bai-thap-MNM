 ...
 */
class OSF_Elementor_Posts_grid_Widget extends Elementor\Widget_Base {
	...
	public function get_title() {
		return __( 'Opal Posts Grid', 'opalelementor' );
	}
	...
	protected function _register_controls() {
		...
		$this->add_control(
			'display_description',
			[
				'label'        => __( 'Display Description', 'opalelementor' ),
				'type'         => \Elementor\Controls_Manager::SELECT,
				'default'      => 'no',
				'options'      => [
					'yes' => 'Yes',
				...
				'prefix_class' => 'display_description-',
				'condition'    => [
					'style' => 'grid',
				],
			]
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .entry-content .entry-title',
	...
	protected function render() {
		...
		$this->add_render_attribute( 'wrapper', 'class', 'elementor-post-wrapper wpopal-blog-' . $settings['style'] . '-style' );
