...
class OSF_Elementor_Site_logo_Widget extends Widget_Image {
    ...
    public function get_title() {
        return __( 'Opal Site Logo', 'opalelementor' );
    }
    ...
    protected function _register_controls() {
        ...
        $this->start_controls_section(
            'section_extra',
            [
                'label' => __( 'Logo Site', 'opalelementor' ),
            ]
        );
        $this->add_control(
            'logo_select',
            [
                'label' => __( 'Image from', 'opalelementor' ),
                'type' => Controls_Manager::SELECT,
                'default' => 'site_logo',
                'options' => [
                    'site_logo' => __( 'Use Site Logo', 'opalelementor' ),
                    'customize' => __( 'Custom Logo', 'opalelementor' ),
                ]
            ]
        );
