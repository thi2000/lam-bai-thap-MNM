...
Start talking: [![Gitter](https://img.shields.io/gitter/room/holger1411/latehome_free.svg?maxAge=2592000?style=flat-square)](https://gitter.im/holger1411/latehome_free)
...
Child Theme Project: [https://github.com/holger1411/latehome_free-child](https://github.com/holger1411/latehome_free-child)
...
- Jetpack ready.
- [Child Theme](https://github.com/holger1411/latehome_free-child) ready.
- Translation ready.
...
- The `/css/theme.css` and it´s minified little brother `/css/theme.min.css` file(s) provides all styles. It is composed of five different SCSS sets and one variable file at `/sass/theme.scss`:
                  ...
                  - 3 "latehome_free/latehome_free"; // <--------- Some basic WordPress stylings and needed styles to combine Boostrap and Underscores
...
- Download the latehome_free folder from GitHub or from wpopal.com
- IMPORTANT: If you download it from GitHub make sure you rename the "latehome_free-master.zip" file just to "latehome_free.zip" or you might have problems using child themes !!
